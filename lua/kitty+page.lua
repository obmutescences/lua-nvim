...
return function(INPUT_LINE_NUMBER)
	...
	vim.api.nvim_buf_set_keymap(term_buf, "n", "u", "k", { noremap = true, silent = true })
	vim.api.nvim_buf_set_keymap(term_buf, "n", "n", "h", { noremap = true, silent = true })
	vim.api.nvim_buf_set_keymap(term_buf, "n", "i", "l", { noremap = true, silent = true })
	vim.api.nvim_buf_set_keymap(term_buf, "v", "u", "k", { noremap = true, silent = true })
	vim.api.nvim_buf_set_keymap(term_buf, "v", "n", "h", { noremap = true, silent = true })
	vim.api.nvim_buf_set_keymap(term_buf, "v", "i", "l", { noremap = true, silent = true })
