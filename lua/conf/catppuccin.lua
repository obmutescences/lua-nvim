	...
	highlight_overrides = {
		all = function(colors)
			return {
				...
				BlinkCmpMenuSelection = { fg = colors.red, style = { "italic" } },
				...
				TSConstant = { fg = colors.text, style = { "bold" } },
				...
				TSFuncBuiltin = { fg = colors.green, style = { "italic" } },
				...
				TSType = { fg = colors.sapphire, style = { "bold" } },
